    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="84px" viewBox="0 0 24 24" width="84px" fill="#ef4444">
                    <g>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Enjoy your own dashboard of our website.
                                You can find what you want to see including daily schedule, total monthly and so on there.
                                Thank you for your concern of our service.
                            </p>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Request</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Feel free to send request to have your own time.
                                Here are some options for request such as Marriage leave, Parental leave, Apprenticeship Course, Company Medical Examination, Holidays and so on.
                            </p>
                        </div>
